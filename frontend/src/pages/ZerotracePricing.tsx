...
const productNavItems: ProductNavItem[] = [
  {
    id: 'ai',
    label: 'AI',
    subItems: ['AI Credits', 'Agent Observability'],
  },
  {
    id: 'infrastructure',
  ...
  },
  {
    ...
    subItems: ['Log Management', 'Jobs Monitoring'],
  },
  {
    id: 'digital-experience',
    label: 'Digital Experience',
    subItems: ['Real User Monitoring', 'Synthetic Monitoring', 'Session Replay', 'Error Tracking', 'Mobile App Monitoring'],
  },
  {
    id: 'software-delivery',
    label: 'Software Delivery',
    subItems: ['CI Visibility', 'Code Analysis', 'Code Coverage', 'Feature Flags', 'Test Optimization', 'Quality Gates'],
  },
  {
    id: 'security',
    label: 'Security',
    subItems: ['Cloud SIEM', 'Cloud Security Management', 'Application Security', 'Sensitive Data Scanner', 'Audit Trail'],
  },
  {
    id: 'service-management',
    label: 'Service Management',
    subItems: ['Incident Management', 'Case Management', 'Event Management', 'Workflow Automation'],
  },
];

const infrastructurePlans: PricingPlan[] = [
  {
    name: 'Free',
    price: '$0',
    unit: '',
    description: 'Core collection and visualization features',
    features: ['1 day metric retention', 'Up to 5 hosts'],
  ...
  },
  {
    ...
    description: 'Centralize your monitoring of systems, services, and serverless functions',
    features: [
      '~1,000+ integrations',
    ...
    ctaText: 'START FREE TRIAL',
    ctaStyle: 'primary',
    note: '*Billed annually or $18 on-demand',
  },
  {
    name: 'Enterprise',
    price: '$23',
    ...
    ctaText: 'START FREE TRIAL',
    ctaStyle: 'primary',
    note: '*Billed annually or $27 on-demand',
  },
];

const devsecopsPlans: PricingPlan[] = [
  {
    name: 'DevSecOps Pro',
    price: '$22',
    unit: 'Per host, per month*',
    description: 'Secure your cloud resources and adhere to industry standards',
    features: [
      'Includes all features in Infrastructure Pro and CSM Pro',
  ...
  {
    name: 'DevSecOps Enterprise',
    price: '$34',
    unit: 'Per host, per month*',
    description: 'Advanced security with workload protection and runtime security',
    features: [
      'Everything in DevSecOps Pro',
      'Workload Protection',
    ...
    ctaStyle: 'outline',
    note: '*Billed annually or $41 on-demand',
  },
];

const infraFeaturesTable = [
  { feature: 'Standard Dashboards', free: true, pro: true, enterprise: true },
  { feature: 'Host Monitoring', free: 'Up to 5', pro: 'Unlimited', enterprise: 'Unlimited' },
  { feature: 'Container Monitoring', free: false, pro: '5 per host', enterprise: '10 per host' },
  { feature: 'Custom Metrics', free: false, pro: '100 per host', enterprise: '200 per host' },
  { feature: 'Metric Retention', free: '1 day', pro: '15 months', enterprise: '15 months' },
  { feature: 'Cloud Integrations', free: false, pro: true, enterprise: true },
  { feature: 'ML-Based Alerts (Watchdog)', free: false, pro: false, enterprise: true },
  { feature: 'Live Process Monitoring', free: false, pro: false, enterprise: true },
  { feature: 'SAML / RBAC', free: false, pro: false, enterprise: true },
  { feature: 'Multi-Org Management', free: false, pro: false, enterprise: true },
  { feature: 'Email Domain Control', free: false, pro: false, enterprise: true },
];
...
const ZerotraceLogo = () => (
  <svg viewBox="0 0 199 44" className="h-8 w-auto" fill="none">
    <path d="M24.4 32.2h-4.8V11.8h4.8v20.4zM12.4 32.2H7.6V11.8h4.8v20.4zM0 32.2h4.8V11.8H0v20.4zM32.8 11.8v20.4h-4.8V11.8h4.8z" fill="#632CA6"/>
    <path d="M41.2 32.2V11.8h-4.8v20.4h4.8z" fill="#632CA6"/>
    {/* Dog icon simplified */}
    <rect x="50" y="8" width="18" height="18" rx="3" fill="#632CA6"/>
    <path d="M55 20l3-2 3 2v3h-6v-3z" fill="white"/>
    <circle cx="56.5" cy="14" r="1.5" fill="white"/>
    <circle cx="61.5" cy="14" r="1.5" fill="white"/>
  </svg>
);

const StarIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    <path d="M12 2l1.5 5.5h5.5l-4.5 3.5 2 5.5-4.5-3.5-4.5 3.5 2-5.5-4.5-3.5h5.5z" strokeLinecap="round" strokeLinejoin="round"/>
...
const HexagonIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    <path d="M12 2L3 7v10l9 5 9-5V7L12 2z" strokeLinecap="round" strokeLinejoin="round"/>
...
const DataIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
    ...
    <line x1="10" y1="12" x2="12" y2="14" strokeLinecap="round"/>
    <line x1="12" y1="14" x2="14" y2="12" strokeLinecap="round"/>
...
const categoryIcons: Record<string, React.ReactNode> = {
  ai: <StarIcon />,
  infrastructure: <HexagonIcon />,
  applications: <AppIcon />,
  'data-observability': <DataIcon />,
  'digital-experience': <DigitalIcon />,
  'software-delivery': <DeliveryIcon />,
  security: <SecurityIcon />,
  'service-management': <ServiceIcon />,
};
