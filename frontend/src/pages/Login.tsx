  ...
  return (
    <div className="auth-split">
      ...
      <aside className="hidden lg:flex flex-col justify-between bg-zinc-950 text-zinc-100 p-14 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-900/40 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/4" />
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold tracking-tighter leading-none mb-6">
            ...
            <br />
            <span className="text-brand-400">{t('auth.heroTitleLine3')}</span>
          </h1>
      ...
      {/* Right: Form */}
      <main className="flex items-center justify-center px-8 py-16 bg-white">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <div className="mb-10">
            <h2 className="text-3xl font-bold tracking-tight text-zinc-900 mb-2">{t('auth.welcomeBack')}</h2>
            <p className="text-zinc-500">{t('auth.signInToOrg')}</p>
          </div>

          <Form layout="vertical" onFinish={onFinish} size="large" requiredMark={false}>
            <Form.Item
              name="email"
              label={<span className="text-sm font-medium text-zinc-700">{t('auth.email')}</span>}
